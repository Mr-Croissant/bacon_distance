...
def on_click_calculate(conn: sqlite3.Connection, actor1: str, actor2: str, update_container: DeltaGenerator):
...
def generate_actor_picking(conn: sqlite3.Connection):
    ...
    with input_container:
        ...
        st.button("Calculate", on_click=on_click_calculate, args=[conn, actor1, actor2, updates_container])
